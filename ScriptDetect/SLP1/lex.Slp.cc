...
void *Slpalloc (yy_size_t  );
void *Slprealloc (void *,yy_size_t  );
void Slpfree (void *  );
...
static yyconst flex_int16_t yy_accept[21] =
    {   0,
        0,    0,   15,   13,    1,   14,   12,    6,   11,    2,
        8,    5,    4,    7,    3,    1,    9,    8,   10,    0
    } ;
...
{
	delete [] yy_state_buf;
	Slpfree(yy_start_stack  );
	yy_delete_buffer( YY_CURRENT_BUFFER );
	Slpfree(yy_buffer_stack  );
}
...
int yyFlexLexer::yy_get_next_buffer()
{
		...
		while ( num_to_read <= 0 )
			...
			if ( b->yy_is_our_buffer )
				...
				b->yy_ch_buf = (char *)
					...
					Slprealloc((void *) b->yy_ch_buf,b->yy_buf_size + 2  );
				}
			else
	...
	if ((yy_size_t) ((yy_n_chars) + number_to_move) > YY_CURRENT_BUFFER_LVALUE->yy_buf_size) {
		...
		YY_CURRENT_BUFFER_LVALUE->yy_ch_buf = (char *) Slprealloc((void *) YY_CURRENT_BUFFER_LVALUE->yy_ch_buf,new_size  );
    ...
    YY_BUFFER_STATE yyFlexLexer::yy_create_buffer( std::istream* file, int size )
{
	...
	b = (YY_BUFFER_STATE) Slpalloc(sizeof( struct yy_buffer_state )  );
	if ( ! b )
	 ...
	 */
	b->yy_ch_buf = (char *) Slpalloc(b->yy_buf_size + 2  );
	if ( ! b->yy_ch_buf )
		YY_FATAL_ERROR( "out of dynamic memory in yy_create_buffer()" );
...
void yyFlexLexer::yyensure_buffer_stack(void)
{
	...
	if (!(yy_buffer_stack)) {
         ...
         */
		num_to_alloc = 1;
		(yy_buffer_stack) = (struct yy_buffer_state**)Slpalloc
	...
	if ((yy_buffer_stack_top) >= ((yy_buffer_stack_max)) - 1){
		...
		(yy_buffer_stack) = (struct yy_buffer_state**)Slprealloc
								((yy_buffer_stack),
								num_to_alloc * sizeof(struct yy_buffer_state*)
								);
		if ( ! (yy_buffer_stack) )
    ...
    void yyFlexLexer::yy_push_state( int new_state )
{
		...
		if ( ! (yy_start_stack) )
			(yy_start_stack) = (int *) Slpalloc(new_size  );

		else
			(yy_start_stack) = (int *) Slprealloc((void *) (yy_start_stack),new_size  );
...
void *Slpalloc (yy_size_t  size )
{
	return (void *) malloc( size );
}

void *Slprealloc  (void * ptr, yy_size_t  size )
{
...
void Slpfree (void * ptr )
{
	free( (char *) ptr );	/* see Slprealloc() for (char *) cast */
}
