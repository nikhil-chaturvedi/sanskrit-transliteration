...
short int BenEncode::encodeVyanjan(char *str, unsigned long length, bool special, bool halant) {
...
short int BenEncode::encodeSwar(char *str, unsigned long length) {
    short int encoding = 0;
    string toEncode(str);
    if (length != 3) {
        printf("Error in tokenisation!");
...
short int BenEncode::encodePunctuation(char *str, unsigned long length) {
    short int encoding = 0;
    string toEncode(str);
    if (length == 3) {
        encoding |= 0x3a << 5;
...
short int BenEncode::encodeNumber(char *str, unsigned long length) {
    short int encoding = 0;
    string toEncode(str);
    if (length != 3) {
        printf("Error in tokenisation!");
