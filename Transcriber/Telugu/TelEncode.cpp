...
short int TelEncode::encodeVyanjan(char *str, unsigned long length, bool special, bool halant) {
...
short int TelEncode::encodeSwar(char *str, unsigned long length) {
    short int encoding = 0;
    string toEncode(str);
    if (length != 3) {
        printf("Error in tokenisation!");
...
short int TelEncode::encodePunctuation(char *str, unsigned long length) {
    short int encoding = 0;
    string toEncode(str);
    if (length == 3) {
        encoding |= 0x3a << 5;
...
short int TelEncode::encodeNumber(char *str, unsigned long length) {
    short int encoding = 0;
    string toEncode(str);
    if (length != 3) {
        printf("Error in tokenisation!");
