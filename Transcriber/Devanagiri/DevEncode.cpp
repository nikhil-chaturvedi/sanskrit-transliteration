...
short int DevEncode::encodeVyanjan(char *str, unsigned long length, bool special, bool halant) {
...
short int DevEncode::encodeSwar(char *str, unsigned long length) {
    short int encoding = 0;
    string toEncode(str);
    if (length != 3) {
        printf("Error in tokenisation!");
...
short int DevEncode::encodePunctuation(char *str, unsigned long length) {
    short int encoding = 0;
    string toEncode(str);
    if (length == 3) {
        encoding |= 0x3a << 5;
...
short int DevEncode::encodeNumber(char *str, unsigned long length) {
    short int encoding = 0;
    string toEncode(str);
    if (length != 3) {
        printf("Error in tokenisation!");
