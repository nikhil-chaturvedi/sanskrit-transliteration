...
short int GurEncode::encodeVyanjan(char *str, unsigned long length, bool special, bool halant) {
...
short int GurEncode::encodeSwar(char *str, unsigned long length) {
    short int encoding = 0;
    string toEncode(str);
    if (length != 3) {
        printf("Error in tokenisation!");
...
short int GurEncode::encodePunctuation(char *str, unsigned long length) {
    short int encoding = 0;
    string toEncode(str);
    if (length == 3) {
        encoding |= 0x3a << 5;
...
short int GurEncode::encodeNumber(char *str, unsigned long length) {
    short int encoding = 0;
    string toEncode(str);
    if (length != 3) {
        printf("Error in tokenisation!");
