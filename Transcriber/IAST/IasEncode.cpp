...
short int IasEncode::encodeVyanjan(char *str, unsigned long length, bool special) {
    ...
    int index = 0;
    string swars[] = {"a","i","u","ā","ī","ē","ṛ","ṝ","ḷ","ḹ","ō","ū"};
...
short int IasEncode::encodeSwar(char *str, unsigned long length) {
    short int encoding = 0;
    string toEncode(str);
    /*if (length != 1) {
        printf("Error in tokenisation!");
...
short int IasEncode::encodePunctuation(char *str, unsigned long length) {
    short int encoding = 0;
    string toEncode(str);
    if (length != 1) {
        printf("Error in tokenisation!");
...
short int IasEncode::encodeNumber(char *str, unsigned long length) {
    short int encoding = 0;
    string toEncode(str);
    if (length != 1) {
        printf("Error in tokenisation!");
